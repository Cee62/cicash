...
echo
echo "1) PyPI  (name 'agentcash' was unclaimed when this was written)"
echo "     python3 -m pip install --upgrade twine"
echo "     python3 -m twine upload dist/*          # needs your API token"
echo
echo "2) GitHub"
echo "     gh repo create agentcash --public --source=. --remote=origin --push"
echo "   or, without the gh CLI:"
echo "     git remote add origin git@github.com:<you>/agentcash.git"
